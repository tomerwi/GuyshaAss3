...
namespace RecommenderSystem
{
    class Program
    {
        ...
        static void Assignment3()
        {
            ...
            List<string> lRecommendations = rs.Recommend("Pearson", "6", 5);
            ...
            Dictionary<int,Dictionary<string,Dictionary<string, double>>> dResults = rs.ComputePrecisionRecall(lMethods, lLengths, 1000);
